...
export default function Home() {
  return (
    <div className='' style={{'--svg': 'hsl(var(--primary))'} as React.CSSProperties}>
      ...
      <div className='-mt-10 -mb-1 md:-mt-24 lg:-mt-42 z-20 overflow-hidden hidden sm:block'>
        <svg className='' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"><path fill="var(--svg)" fillOpacity="1" d="M0,128L48,154.7C96,181,192,235,288,245.3C384,256,480,224,576,208C672,192,768,192,864,197.3C960,203,1056,213,1152,197.3C1248,181,1344,139,1392,117.3L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"></path></svg> 
      </div>

      <div className=' -mb-1 md:-mt-24 lg:-mt-42 z-20 overflow-hidden block sm:hidden bg-secondary rounded-t-3xl'>
        <EditorWrapper documentId="intro"/> 
      </div>
      <div className='h-16 -mt-10 bg-primary overflow-hidden rounded-t-3xl'></div>
      ...
      <div className='-mt-1 h-[400px] bg-secondary flex justify-start p-16 items-center'>
