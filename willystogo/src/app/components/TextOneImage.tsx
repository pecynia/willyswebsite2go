...
const TextSingleImage: React.FC<SingleImageProps> = ({ documentId, image, imagePosition = "left", theme = "dark", verticalPosition= "above", className }) => {
  ...
  const TextEditor = (
    <motion.div layout
      ...
      className={twMerge(getShadowClass(), "mb-20 col-span-full lg:col-span-2 bg-secondary pb-10 flex px-10 pt-4 min-w-[200px] max-w-full", imagePosition === 'left' && 'lg:order-2')}>
