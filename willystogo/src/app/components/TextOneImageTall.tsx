...
const TextSingleImageTall: React.FC<SingleImageProps> = ({ documentId, image, imagePosition = "left", theme = "dark", verticalPosition= "above", className }) => {
  ...
  const SingleImg = (
    <div className={twMerge("pt-20 lg:pt-0 relative col-span-full lg:col-span-3 h-[500px] lg:h-full", imagePosition === 'right' && 'lg:order-2')}>
      <motion.div layout
        ...
        className={twMerge("w-[70%] md:w-[40%] lg:w-[55%] lg:h-[40rem] h-full lg:absolute top-[10%] lg:left-[10%] mx-auto lg:ml-10 lg:mr-0 flex-shrink-0", className)}
      >
